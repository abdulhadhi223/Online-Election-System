                ...
                <nav class="navbar navbar-expand-lg navbar-light mu-navbar">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto mu-navbar-nav">
                            ...
                            <li class="nav-item"><a href="User_login.jsp">User</a></li>
                            <li class="nav-item active"><a href="Admin_login.jsp">Admin</a></li>
                        </ul>
                    </div>
                </nav>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="mu-contact-form-area">
                                                ...
                                                <form method="post" action="admin" class="mu-contact-form">
