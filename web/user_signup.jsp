                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mu-contact-form-area">
                                                ...
                                                <form method="post" action="user_reg" class="mu-contact-form">
                                                    <div class="form-group">  
                                                        <span class="fa fa-user mu-contact-icon"></span>              
                                                        <input type="text" class="form-control" placeholder="Name" id="name" name="username" required="required" />
                                                    </div>
                                                    <div class="form-group">  
                                                        <span class="fa fa-calendar mu-contact-icon"></span>              
                                                        <input type="date" class="form-control" placeholder="DOB" id="name" name="dob" required="required" />
                                                    </div>
                                                    <div class="form-group">  
                                                        <span class="fa fa-envelope mu-contact-icon"></span>              
                                                        <input type="email" class="form-control" placeholder="Email" id="name" name="email" required="required" />
                                                    </div><div class="form-group">  
                                                        <span class="fa fa-male mu-contact-icon"></span>             
                                                    ...
                                                    <div class="form-group">  
                                                        ...
                                                        <input type="text" class="form-control" placeholder="Phone No" id="name" name="phone" required="required" />
                                                    </div>
                                                    <div class="form-group">  
                                                        <span class="fa fa-home mu-contact-icon"></span>              
                                                        <input type="text" class="form-control" placeholder="Address" id="name" name="address" required="required" />
                                                    </div>
                                                    <div class="form-group">  
                                                    ...
                                                    <div class="form-group"> 
                                                        <button type="submit" class="mu-send-msg-btn"><span>Sign Up</span></button>
                                                    </div>    
                                                </form>
                                            </div>
                                        </div>
