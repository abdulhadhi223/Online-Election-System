                ...
                <nav class="navbar navbar-expand-lg navbar-light mu-navbar">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto mu-navbar-nav">
                            ...
                            <li class="nav-item active"><a href="Add_election.jsp">Add Election</a></li>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="mu-contact-form-area">
                                                ...
                                                <form method="post" action="add_election" class="mu-contact-form">
                                                    <label style="float: left">Election Name:</label> <br>
                                                    <div class="form-group">
                                                        <span class="fa fa-comment mu-contact-icon"></span>              
                                                        <input type="text" class="form-control" placeholder="Enter Election Name" name="election_name" required="required" />
                                                    </div>
                                                    <label style="float: left">End Date:</label> <br>
                                                    <div class="form-group">  
